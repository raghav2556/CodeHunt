...
return (
  ...
  className="
    ...
    mx-auto
    mb-4
    drop-shadow-[0_0_20px_rgba(0,255,135,0.25)]
  "
/>

        <div className="flex items-center justify-center gap-3 mb-3">
          <span className="w-1.5 h-1.5 rounded-full bg-[var(--neon)]" />
          <p className="text-[0.75rem] font-hud tracking-[0.22em] uppercase text-[var(--neon)]">
            Recovery Terminal
          </p>
          <span className="w-1.5 h-1.5 rounded-full bg-[var(--neon)]" />
        </div>

        <p className="text-[0.62rem] tracking-[0.15em] uppercase text-[var(--text-muted)]">
  ...
  className="
    ...
    bg-[rgba(2,12,27,0.82)]
    backdrop-blur-xl
    shadow-[0_0_40px_rgba(0,255,135,0.08)]
  "
>
